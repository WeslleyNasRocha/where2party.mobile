...
import { Content, Text, Container, Header, Button, Icon, Thumbnail } from 'native-base';
        ...
        return (
            <Container>
                <Content style={{ backgroundColor: '#9c27b0' }}>
                    <Thumbnail large bordered source={require("../../../assets/img/Demo_Drawer.png")}
                        style={{ alignSelf: 'center', marginTop: 20, height: 150, width: 150 }} />
                    <Button
                        iconLeft
                        block
                    ...
                    >
                        ...
                        <Text style={{ color: 'rgba(255,255,255,0.8)', alignSelf: "center" }}>Criar Evento</Text>
                    </Button>
                    <Button
                        iconLeft
                        block
                    ...
                    >
                        <Icon name='settings' />
                        <Text style={{ color: 'rgba(255,255,255,0.8)', alignSelf: "center" }}>Configurações</Text>
                    </Button>
                    <Button
                        iconLeft
                        onPress={() => this.logout()}
